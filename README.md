# How Do the Antecedents to Parental Incarceration Shape Children's School Attendance? - Replication Package
...
- Garrett Baker<sup>1,*</sup>
- Anne Sofie Tegner Anker<sup>2</sup>
- Noa Hendel<sup>2,†</sup>
- Lars Højsgaard Andersen<sup>2</sup>
- Chris Wildemann<sup>1,2</sup>
...
\* Corresponding author (paper-related questions): [garrett.baker@duke.edu](garrett.baker@duke.edu)  
...
```bash
git clone https://github.com/manselans/Crime-or-Contact.git
cd Crime-or-Contact
```
